#!/bin/bash
export master='10.0.0.10'
export node1='10.0.0.11'
...
k8sServiceHost: "10.0.0.10" # use master node in kind network
...
ipam:
  mode: "cluster-pool"
  operator:
    clusterPoolIPv4PodCIDRList: ["172.16.1.0/16"]
...
####  [Stdout] KubeProxyReplacement:   Strict   [eth0 10.0.2.15, eth1 10.0.0.10 (Direct Routing)]
